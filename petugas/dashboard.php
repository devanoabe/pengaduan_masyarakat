	...
	<div class="col m6">
		...
		<div class="col m3">
		  <div style="border-radius: 20px" class="card white">
			...
			<?php 
				$query = mysqli_query($koneksi,"SELECT * FROM transaksi WHERE status='proses'");
			 ...
			 <i class="material-icons">book</i>
		      <span style="font-weight: bold;  margin-top: 20px" class="card-title">Laporan Status Proses</span>
			  <h5><?php echo $jlmmember; ?></h5>
		      <p></p>
		    </div>
		  </div>
		</div>	
		...
		<div class="col m3">
			...
			<?php 
			 ...
			 <i class="material-icons">question_answer</i>
		      <span style="font-weight: bold;  margin-top: 20px" class="card-title">Laporan Ditanggapi</span>
