        <div class="row">
          <div class="col s12 m9">
			...
			padding-left: 7px; color:#ef69bf; margin-top: 120px">Respon</h3>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<a style="color: #ef69bf; background-color: white;
							...
							font-weight: bold; " class="btn modal-trigger" href="#more?id_tanggapan=<?php echo $r['id_tanggapan'] ?>">More</a> 
							
			<a style="color: white; background-color: #ef69bf;
							border: 2.5px solid #ef69bf; box-shadow: none;
							font-weight: bold;" class="btn" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=tanggapan_hapus&id_tanggapan=<?php echo $r['id_tanggapan'] ?>">Hapus</a></td>
