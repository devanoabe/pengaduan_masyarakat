	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN masyarakat ON pengaduan.nik=masyarakat.nik 
		...
		<tr>
			...
			<a style="color: #ef69bf; background-color: white;
							...
							font-weight: bold" class="btn modal-trigger" class="btn modal-trigger blue" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">More</a>  
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>" class="modal">
          <div class="modal-content">
            <h3 style="font-weight: bold; color: #ef69bf;" class="text">Detail</h3>
